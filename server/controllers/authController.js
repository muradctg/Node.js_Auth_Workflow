...
const register = async (req, res) => {
  ...
  // console.log(protocol, host, forwardedHost, forwardedProtocol, tempOrigin)
...
if (existingToken) {
  ...
  // if we don't return Javascript will keep on reading the following code
  return
}

// The following code creates the Token in the database with a new value for refreshToken (for the first time Login); once it's
// created, the above functionality will take place where there is already a Token user (Login later)
